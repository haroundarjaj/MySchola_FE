...
// project imports
import { CssBaseline, styled, Typography, useTheme } from '@mui/material';
...
// import backgroundImage from 'assets/images/loading/loading-background.jpg'
    ...
    <>
      <Box sx={{ display: 'flex', paddingBottom: 3 }}>
        ...
        <Main theme={theme} open={leftDrawerOpened}>
          {/* breadcrumb */}
          <Breadcrumbs separator={IconChevronRight} icon icons title rightAlign />
          <Outlet />
        </Main>
        <Customization />
      </Box>
